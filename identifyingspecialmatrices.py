# -*- coding: utf-8 -*-
"""Копия блокнота "IdentifyingSpecialMatrices.ipynb"

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1zv4LVsxj31eY3t1XfH4SP7xcclb-fTx5
...
def fixRowOne(A) :
    A[1] = A[1] - A[1,0] * A[0] #Делаем так, чтобы первый элемент в строке стал нулём, но при этом меняем всю строку, иначе нарушим элементарное преобразование по Гауссу 
    if A[1,1] == 0 :
        A[1] = A[1] + A[2]
        A[1] = A[1] - A[1,0] * A[0]
    if A[1,1] == 0 :
